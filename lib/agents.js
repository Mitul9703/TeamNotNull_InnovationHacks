...
export const EVALUATION_CRITERIA = [
  {
    label: "Confidence",
    description: "How steady, assured, and credible the speaker feels under pressure.",
  },
  {
    label: "Clarity",
    description: "How clearly the speaker explains ideas, examples, and conclusions.",
  },
  {
    label: "Depth",
    description: "How well the speaker supports claims with specifics, reasoning, and context.",
  },
  {
    label: "Composure",
    description: "How calm, structured, and responsive the speaker remains during questioning.",
  },
];
...
export function buildMockEvaluation(slug) {
  const base = STATIC_POST_SESSION_METRICS[slug] || DEFAULT_METRICS;
